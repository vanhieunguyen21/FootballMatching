...
import com.svmc.footballMatching.databinding.FragmentEditPlayerSpecsBinding;

import java.util.HashMap;
import java.util.Map;

public class EditPlayerSpecsFragment extends Fragment {
    private FragmentEditPlayerSpecsBinding binding;
    private EditPlayerSpecsViewModel viewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentEditPlayerSpecsBinding.inflate(inflater);
        binding.setLifecycleOwner(this);
        viewModel = new ViewModelProvider(this).get(EditPlayerSpecsViewModel.class);
    ...
    private void initComponents(final Context context) {
        ...
        binding.toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                getParentFragmentManager().beginTransaction().detach(EditPlayerSpecsFragment.this).commit();
            }
        });
        ...
        binding.resetImageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                binding.heightTextInputEditText.setText(Integer.toString(viewModel.playerLiveData.getValue().getHeight()));
                binding.weightTextInputEditText.setText(Integer.toString(viewModel.playerLiveData.getValue().getWeight()));
            }
        });
