...
import com.svmc.footballMatching.ui.team.match.team.TeamProfileFragment;

import java.util.ArrayList;
import java.util.List;

public class MatchTeamsRecyclerViewAdapter extends RecyclerView.Adapter<MatchTeamsRecyclerViewAdapter.TeamViewHolder> {
